  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        ...
        <p className='lead-text'>Live gaming with lots of other games. 🚀 Dive into the ultimate gaming adventure! Enjoy stunning graphics, thrilling gameplay, and endless fun. Join the excitement!"
        "Ready to Play? 🎮 Experience the next level of gaming! Battle, build, and conquer your way through epic quests. Play now and unleash your inner champion!.</p>
